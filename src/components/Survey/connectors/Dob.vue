<script>
  ...
  export default {
    ...
    mounted () {
      this.dob = this.$store.getters['survey/dob'] || ''
    },
    computed: {
      disableNext () {
  ...
  <div class="grid-x grid-x-margin">
    <div class="cell small-12 medium-6 medium-offset-3">
      <div class="survey-questions__dob align-center">
        ...
        <div class="spacer sp__top--sm"></div>
        <dob-input class="align-center survey-input" ref="DobInput" v-validate="'required'" data-vv-value-path="dob" :value="dob" name="dob" :error="errors.has('dob')" minAge="18" :feedback="feedback" @keyup.enter="submit" label="" @input="setDob"></dob-input>
